...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title:
      "Expert Solutions | Indore's No.1 Waterproofing Experts",

    description:
      'Eco-friendly waterproofing, heatproofing, and roof coating for big constructions. Call 9644400650 for top services across India!',

    images: [
      'https://indorewaterproofing.com/twitter-image.jpg',
    ],
  },
};
...
const CallIcon = () => {
  return (
    <a
      href="tel:+919644400650"
      aria-label="Call Expert Solutions"
      style={{
        position: 'fixed',
        bottom: '52px',
        right: '41px',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-18374080715"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [
                'expertwaterproofingsolutions',
                'indoreexpertwaterproofingsolutions',
                'expertheatproofingsolutions',
                'experroofcoatingsolutions',
              ],

              description:
                "Expert Solutions is Indore's #1 provider of waterproofing, heatproofing, roof coating, and rainwater harvesting services. Specializing in big constructions, industries, and warehouses with eco-friendly practices, best management, and a strong client network across India.",
              ...
              address: {
                ...
                streetAddress:
                  '32, Anurag Nagar, Gate no 2, Near Jain Mandir, Indore, Madhya Pradesh',
              ...
              serviceType:
                'Waterproofing, Heatproofing, Roof Coating, Rainwater Harvesting',
              ...
              providesService: [
                {
                  ...
                  description:
                    'Expert waterproofing solutions for industries and warehouses.',
                },

                {
                  ...
                  description:
                    'Advanced heatproofing for large constructions.',
                },

                {
                  ...
                  name: 'Roof Coating',
                  description:
                    'Durable roof coating for industrial and commercial buildings.',
                },

                {
                  ...
                  description:
                    'Eco-friendly rainwater harvesting systems.',
                },
              ],
            }),
          }}
